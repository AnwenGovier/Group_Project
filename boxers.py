...
def BattleLevel1():
    ...
    while (HeroPlayerHealth > 0 and Level1Health > 0):
        ...
        print(" The first boxer has been damaged for ",Damage, " and now his health is ",'{0:.3g}'.format(Level1Health))
...
def BattleLevel2():
    ...
    while (HeroPlayerHealth1 > 0 and Level2Health > 0):
        ...
        print(" The second boxer has been damaged for ",Damage, " and now his health ",'{0:.3g}'.format(Level2Health))
        input("\n__________________________________________________________________\n")
        ...
        print(" You have been damaged for ",Damage, " and now your health is ",'{0:.3g}'.format(HeroPlayerHealth1))
        input("\n__________________________________________________________________\n")
...
def BattleLevel3():
    ...
    while (HeroPlayerHealth2 > 0 and Level3Health > 0):
        ...
        print(" The third boxer has been damaged for ",Damage, " and now his health is ",'{0:.3g}'.format(Level3Health))
        input("\n__________________________________________________________________\n")
        ...
        print(" You have been damaged for ",Damage, " and now your health is ",'{0:.3g}'.format(HeroPlayerHealth2))
        input("\n__________________________________________________________________\n")
...
def BattleLevel4():
    ...
    while (HeroPlayerHealth3 > 0 and Level4Health > 0):
        ...
        print(" The fourth boxer has been damaged for ",Damage, " and now his health is ",'{0:.3g}'.format(Level4Health))
        input("\n__________________________________________________________________\n")
        ...
        print(" You have been damaged for ",Damage, " and now your health is ",'{0:.3g}'.format(HeroPlayerHealth3))
        input("\n__________________________________________________________________\n")
...
def BattleLevel5():
    ...
    while (HeroPlayerHealth4 > 0 and Level5Health > 0):
        ...
        print(" The fifth boxer has been damaged for ",Damage, " and now his health is ",'{0:.3g}'.format(Level5Health))
        input("\n__________________________________________________________________")
        ...
        print(" You have been damaged for ",Damage, " and your health is ",'{0:.3g}'.format(HeroPlayerHealth4))
        input("\n__________________________________________________________________")
